...
class CodeInput extends React.Component {
    ...
    render() {
        ...
        if (!this.props.discount && this.state.added) {
            alert = <span className='code-input__alert code-input__alert--wrong'>Code is not valid!</span>;
        } else if (this.props.discount) {
            alert = <span className='code-input__alert code-input__alert--correct'>You received {this.props.discount*100}% discount.</span>;
        }
